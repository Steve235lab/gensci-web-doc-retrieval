...
# 读取集合配置文件
sql = """create table test_create_history(history_id int(11)not null, primary key (history_id), result_path_id int(11)not null, raw_keywords varchar(256)not null, search_completed_flag int(11)not null, uuid int(11)not null, foreign key (uuid) references user(uuid), favourite_flag int(11)not null, start_time varchar(16)not null, end_time varchar(16)not null, filter_article_type varchar(128)not null,"""
